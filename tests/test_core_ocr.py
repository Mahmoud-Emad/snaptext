...
from core.tool import extract_text, get_text_confidence, preprocess_image, enhance_image_pil
...
class TestExtractText:
    ...
    def test_extract_text_multiple_methods(self, mock_tesseract, create_test_image, temp_dir):
...
class TestGetTextConfidence:
    ...
    def test_get_confidence_mock_data(self, mock_tesseract_data, create_test_image, temp_dir):
...
class TestErrorHandling:
    ...
    @patch('core.tool.pytesseract.image_to_string')
    def test_extract_text_all_methods_fail(self, mock_tesseract, create_test_image, temp_dir):
    ...
    @patch('core.tool.pytesseract.image_to_string')
    def test_extract_text_partial_failure(self, mock_tesseract, create_test_image, temp_dir):
